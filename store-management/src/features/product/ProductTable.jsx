...
function ProductTable({ sortCriteria }) {
  ...
  return (
    <>
      <div className="border-stone-200 border-[1px] text-[1.4rem] rounded-md overflow-hidden  mt-4 ">
        <div className="bg-stone-100  items-center px-4 w-auto  grid grid-cols-[0.8fr_1.5fr_0.6fr_0.8fr_1fr_0.5fr] gap-[2.4rem] rounded-md py-2 text-center">
          <div>Image</div>
          <div>Name</div>
          <div>Quantity</div>
          <div>Unit Price</div>
